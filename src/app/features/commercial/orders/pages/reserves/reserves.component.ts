...
export class ReservesComponent implements OnInit, AfterViewInit {
  ...
  getReserveDetails(pageIndex: number) {
    ...
    this.payload.sortOrderBy = this.sortDataBy ? this.sortDataBy : "CODE";
  ...
  initTable() {
    ...
    //  { key: "deliveryAddress.formattedAddress", title: "Address" },
    ];
  }
  ...
  navigateToReserveDetails(row: any) {
    this.router.navigateByUrl(
      `/commercial/orders/reserves-details/${row?.code}`
    );
  }
