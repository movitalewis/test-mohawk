...
export class UserDetailsComponent implements OnInit {
  ...
  breadcrumbItems: BreadcrumbItems = [
    ...
    {
      name: "Your Company",
      path: "/commercial/company/manage-users",
      active: false,
    },
    {
      name: "",
  ...
  onDisableStatus() {
    ...
    this.managementService.disableUser(user).subscribe((res: any) => {
      this.fetchUser();
      this.alertData.message = res.body.message;
      this.modalRef!.hide();
      ...
      (err: any) => {
        if (err) {
          this.managementService.progressHide()
          this.alertData.message = err.error ? err.error : "There was a problem editing the user" ;
  ...
  navigateToAddUser() {
    this.router.navigate(["commercial/company/add-new-user"]);
  }

  navigateToCompanyList() {
    this.router.navigate(["commercial/company/manage-users"]);
  }
