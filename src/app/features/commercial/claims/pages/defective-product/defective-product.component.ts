...
export class DefectiveProductComponent implements OnInit, OnDestroy {
  ...
  changeValdiatorsForReturn(event: any) {
    // if (event == "Return") {
    //   this.addValidators("readyForReturn");
    // } else {
    //   this.removeValidators("readyForReturn");
    // }
  }
  ...
  goToConfirmation(isNewClaim: boolean) {
    ...
    this.router.navigate(
      [`/commercial/claims/defective-product-claim/confirmation`],
      {
        queryParams: {
