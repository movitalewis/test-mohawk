...
export class ProductAddressService {
  ...
  getDefaultShippingAddress(id: any,sampleOrder:boolean=false,productCode:any=''): Observable<any> {
    const url = API_CONSTANTS.defaultShippingAddress;
    return this.apiService.get(url + id + "/getDefaultShippingAddress?fields=DEFAULT?isSample="+sampleOrder+"&productCode="+productCode);
  }
