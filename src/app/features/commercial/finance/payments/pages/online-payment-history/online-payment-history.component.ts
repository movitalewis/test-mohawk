...
import { ScheduledPaymentsService } from "src/app/features/commercial/finance/payments/services/scheduled-payments.service";
...
export class OnlinePaymentHistoryComponent implements OnInit {
  ...
  editPayment(selectedPayment: any, requestFrom: string) {
    ...
    this.router.navigateByUrl("/commercial/finance/payments/make-payment");
  }
