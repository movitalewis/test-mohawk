...
import { ShareViaEmailLightboxComponent } from "src/app/features/commercial/products/components/share-via-email-lightbox/share-via-email-lightbox.component";
...
export class InvoicesListComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.storageService.getItem("uid").subscribe((response: any) => {
      ...
      this.progressHide("progressModal");
    });
      ...
      this.columns = [
        {
          key: "invoiceNumber",
          title: "Document #",
          cssClass: { includeHeader: true, name: this.getSortingClass("invoiceNumber") },
        },
        {
          key: "invoiceDate",
          title: "Document Date",
          cssClass: { includeHeader: true, name: this.getSortingClass("invoiceDate") },
        },
        {
          key: "sideMark",
          title: "Sidemark",
          cssClass: { includeHeader: true,name: this.getSortingClass("sidemark") },
        },
        {
          key: "orderNumber",
          title: "Order Number",
          cssClass: { includeHeader: true, name: this.getSortingClass("orderNumber") },
        },
        {
          key: "orderDate",
          title: "Order Date",
          cssClass: { includeHeader: true, name: this.getSortingClass("orderDate") },
        },
        {
          key: "invoiceDueDate",
          title: "Due Date",
          cssClass: { includeHeader: true, name: this.getSortingClass("invoiceDueDate") },
        },
        {
          key: "poNumber",
          title: "PO #",
        ...
        },
        {
          ...
          cssClass: { includeHeader: true,name: this.getSortingClass("invoiceTotal") },
        },
      ];
  ...
  selectedValues(data: any) {
    if (data.event === "onOrder") {
      ...
      if (this.sortBy !== columnKey) {
        ...
        this.orderbyMap[columnKey] = this.orderbyMap[columnKey] === "ASC" ? "DESC" : "ASC";
      }
