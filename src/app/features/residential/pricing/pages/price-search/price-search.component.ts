...
export class PriceSearchComponent implements OnInit {
  ...
  downloadAllPrices(type: any = "pdf", email: boolean = false) {
    ...
    let url = (API_CONSTANTS.priceSearch + this.uid).replace("{userId}",this.userService.getUserEmail());;
            ...
            this.allData.forEach((obj: any) => {
              for (const key in obj) {
                if (
                  ...
                  key.toLowerCase().includes("pallet")
                ) {
                  const value = obj[key];
  ...
  printPage(isShare: boolean) {
    ...
    const test: any = Object.values(this.headers);
    var headers: any = [];
    var rows = [];
    if (this.productType == "Needlepunch Broadloom") {
      headers = [
        [
          "Style #",
          "Style Name",
          ...
          "Start Date",
          "End Date",
          "Roll Price (Sq. Yd., USD)",
          "Cut Price (Sq. Yd., USD)",
          "Roll Price (Sq. Ft., USD)",
          "Cut Price (Sq. Ft., USD)",
        ],
      ];
    ...
    if (this.productType == "Needlepunch Tile") {
      headers = [
        [
          "Style #",
          "Style Name",
          ...
          "Start Date",
          "End Date",
          "Pallet Price (Sq. Yd., USD)",
          "Carton Price (Sq. Yd., USD)",
          "Pallet Price (Sq. Ft., USD)",
          "Carton Price (Sq. Ft., USD)",
          "Cartons/Pallet",
          "SY/Carton",
        ],
      ];
    ...
    if (this.productType == "Cushion") {
      ...
      rows = data.map((item: any) => [
        ...
        item.warehousePriceSF,
        item.plantDirectPriceSF,
      ]);
    }
    if (this.productType == "Carpet Tile") {
      headers = [
        [
          "Style #",
          "Style Name",
    ...
    if (this.productType == "Resilient Sheet") {
      headers = [
        [
          "Style #",
          "Style Name",
    ...
    if (this.productType == "Resilient LVT") {
      headers = [
        [
          "Style #",
          "Style Name",
  ...
  onSearch(payload: any) {
    ...
    let pload = {
      ...
      futurePrice: false,
      priceType:
        payload.priceType !== null ? payload.priceType : "",
      currentPage: payload.currentPage !== null ? payload.currentPage : 1,
      recordsPerPage:
      ...
      styleDetails: [
        {
          styleNumber: payload.styleNumber !== null ? payload.styleNumber.toUpperCase() : "",
          productCategory:
    ...
    let url = (API_CONSTANTS.priceSearch + uid).replace("{userId}",this.userService.getUserEmail());
  ...
  setColumn(productType: any) {
    ...
    if (productType == "Needlepunch Broadloom") {
      this.columns1 = columnHeader.NeedlepunchBroadloom;
    }
    if (productType == "Needlepunch Tile") {
      this.columns1 = columnHeader.NeedlepunchTile;
    }
  ...
  setHeader(productType: any) {
    ...
    if (productType == "Needlepunch Broadloom") {
      this.headers = header.NeedlepunchBroadloom;
    }
    if (productType == "Needlepunch Tile") {
      this.headers = header.NeedlepunchTile;
    }
  }
