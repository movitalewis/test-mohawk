...
import { PostModificationPlpSavedAddressComponent } from "../post-modification-plp-saved-address/post-modification-plp-saved-address.component";
@Component({
    selector: "residential-post-modification-plp-shipping-address",
    templateUrl: "./post-modification-plp-shipping-address.component.html",
    styleUrls: ["./post-modification-plp-shipping-address.component.scss"],
    standalone: false
})
export class PostModificationPlpShippingAddressComponent implements OnInit {
  isCollapsed = true;
  isCollapsed1 = true;
  isCollapsed2 = true;
  checkboxes = true;
  ...
  openOrderSamplesModal() {
    ...
    const data: any = this.initialData;
