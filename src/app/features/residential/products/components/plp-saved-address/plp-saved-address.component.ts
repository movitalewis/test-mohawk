...
@Component({
    selector: "residential-plp-saved-address",
    templateUrl: "./plp-saved-address.component.html",
    styleUrls: ["./plp-saved-address.component.scss"],
    standalone: false
})
export class PlpSavedAddressComponent implements OnInit {
  ...
  getShippingAddress() {
    this.defaultAddress
      .getDefaultAddress(this.userService.getUserEmail(), 0, "")
      .subscribe((res: any) => {
