...
export const environment = {
  ...
  baseUrl:
   "https://pubqas.virtualservices.mohawkind.com/SOAQ405/vPUB.MHK.COMMCLOUD.OCC.Custom.svc/us_b2b_commercial/",
  baseAPIURl:
    "https://pubqas.virtualservices.mohawkind.com/SOAQ405/vPUB.MHK.COMMCLOUD.OCC.Custom.svc/",
  baseASMAPIURl:
     "https://api.cjjsup9vs1-mohawkcar2-s2-public.model-t.cc.commerce.ondemand.com/",
  baseBloomreachAPIURl:
    "https://staging-cmsapi.mohawkind.com/site/rest/xchange/",
  // virtualServicesAddressValidate:
  //   "https://qas.virtualservices.mohawkind.com/SOAQ402/vEXT.MHK.eMPower.AddressValidation.svc",
  virtualServicesAddressValidate:
  ...
  pdfPath: "https://mohawkdirectory.blob.core.windows.net/crest-staging-spec/xchange/",
  ...
  mohawkToday: "https://ssoproxytst.mohawkind.com/proxy/XUI/?goto=https://staging.mohawktoday.com%2Fauthomatic-handler%2Fxchange&ForceAuth=true&realm=connector&service=Azure_oidc&authIndexType=service&authIndexValue=Azure_oidc&client_id=OIDC_Prod&redirect_uri=https://staging.mohawktoday.com%2Fauthomatic-handler%2Fxchange&scope=openid&state=&response_type=code#login/",
