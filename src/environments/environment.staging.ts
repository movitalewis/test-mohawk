...
export const environment = {
  backendEnvironment:"STAGING (QS5)",
  production: false,
  hostURL: "https://staging-alpha.mohawkxchange.com",
  baseUrl:
...
attachmentDownloadUser: "MHK_OPENTEXT",
  ...
  mohawkToday: "https://ssoproxytst.mohawkind.com/proxy/XUI/?goto=https://mt55.mohawktoday.com%2Fauthomatic-handler%2Fxchange&ForceAuth=true&realm=connector&service=Azure_oidc&authIndexType=service&authIndexValue=Azure_oidc&client_id=OIDC_Sandbox&redirect_uri=https://mt55.mohawktoday.com%2Fauthomatic-handler%2Fxchange&scope=openid&state=&response_type=code#login/",
