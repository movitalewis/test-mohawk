...
export const environment = {
  production: false,
  backendEnvironment:"DEV (QS5)",
  hostURL: "https://dev-alpha.mohawkxchange.com",
  baseUrl:
   "https://tst.virtualservices.mohawkind.com/SOAT302/vPUB.MHK.COMMCLOUD.OCC.Custom.svc/us_b2b_commercial/",
  baseAPIURl:
   "https://tst.virtualservices.mohawkind.com/SOAT302/vPUB.MHK.COMMCLOUD.OCC.Custom.svc/",
  baseASMAPIURl:
     "https://api.cjjsup9vs1-mohawkcar2-d1-public.model-t.cc.commerce.ondemand.com/",
  ...
  sentinentURL:'https://pubqas.virtualservices.mohawkind.com/SOAQ405/vPUB.MHK.COMMCLOUD.OCC.Custom.svc',
    sentinentUser: "CREST_HYBRIS_ESB",
  sentinentPwd: "W3g0t1tD*ne!",
